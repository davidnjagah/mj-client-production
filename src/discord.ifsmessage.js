...
var IFSDiscordMessage = /** @class */ (function () {
    ...
    IFSDiscordMessage.prototype.FilterMessages = function (timestamp, rid, loading) {
        return __awaiter(this, void 0, void 0, function () {
            var data, i, item, itemTimestamp, uri, progress, content, _a, proxy_url, width, height, msg;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        for (i = 0; i < data.length; i++) {
                            ...
                            if (item.author.id === this.config.BotId &&
                                ...
                                _a = item.attachments[0], proxy_url = _a.proxy_url, width = _a.width, height = _a.height;
                                msg = {
                                    content: content,
                                    rid: rid,
                                    id: item.id,
